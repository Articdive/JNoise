...
public class SuperSimplexGenerator extends NoiseGenerator<SuperSimplexResult> {
    ...
    @Override
    @NotNull
    public SuperSimplexResult evaluateNoise(double x, double y) {
        x *= frequency;
        y *= frequency;
        ...
        return new SuperSimplexResult(result);
    }

    @Override
    @NotNull
    public SuperSimplexResult evaluateNoise(double x, double y, double z) {
        x *= frequency;
        y *= frequency;
        z *= frequency;
    ...
    @Override
    @NotNull
    public SuperSimplexResult evaluateNoise(double x, double y, double z, double w) {
        x *= frequency;
        y *= frequency;
        z *= frequency;
        w *= frequency;
