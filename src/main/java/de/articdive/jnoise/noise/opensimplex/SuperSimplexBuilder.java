 ...
 * @author Articdive
 */
public final class SuperSimplexBuilder extends NoiseBuilder implements Seeded<SuperSimplexBuilder> {
    ...
    /**
     * Sets the frequency for the {@link SuperSimplexGenerator}.
     *
     * @param frequency the new frequency for the {@link SuperSimplexGenerator}.
     * @return {@link SuperSimplexBuilder} this
     */
    @NotNull
    public SuperSimplexBuilder setFrequency(double frequency) {
        if (frequency <= 0) {
     ...
     *
     * @param variant2D the new {@link Simplex2DVariant} for the {@link SuperSimplexGenerator}.
     * @return {@link SuperSimplexBuilder} this
     */
    @NotNull
    public SuperSimplexBuilder setVariant2D(@NotNull Simplex2DVariant variant2D) {
     ...
     *
     * @param variant3D the new {@link Simplex3DVariant} for the {@link SuperSimplexGenerator}.
     * @return {@link SuperSimplexBuilder} this
     */
    @NotNull
    public SuperSimplexBuilder setVariant3D(@NotNull Simplex3DVariant variant3D) {
     ...
     *
     * @param variant4D the new {@link Simplex4DVariant} for the {@link SuperSimplexGenerator}.
     * @return {@link SuperSimplexBuilder} this
     */
    @NotNull
    public SuperSimplexBuilder setVariant4D(@NotNull Simplex4DVariant variant4D) {
    ...
    @NotNull
    public JNoise build() {
        return JNoise.build(new SuperSimplexGenerator(seed, frequency, variant2D, variant3D, variant4D));
    }

    public static long getSeed(SuperSimplexBuilder builder) {
        return builder.seed;
    }
}
