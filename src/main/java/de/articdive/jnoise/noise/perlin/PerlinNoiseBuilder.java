...
public final class PerlinNoiseBuilder extends NoiseBuilder<PerlinNoiseBuilder> {
     ...
     */
    @NotNull
    public PerlinNoiseBuilder setInterpolationType(@NotNull InterpolationType interpolationType) {
    ...
    @NotNull
    public JNoise build() {
        return JNoise.build(new PerlinNoiseGenerator(seed, interpolationType, frequency));
    }
}
